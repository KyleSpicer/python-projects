...
def return_cards_rank_as_straight(a_hand):
    ...
    def generate_hand_with_mapped_picture_cards(map_picture_cards):
        ...
        for num_id_or_pic_card in ranks_maybe_with_face_cards:
            if num_id_or_pic_card not in map_picture_cards:
                ...
                pics_mapped_to_numbers.append(map_picture_cards[num_id_or_pic_card])
    ...
    # Ace high (14).
    map_picture_cards_ace_high = {"Ace": 14, "King": 13, "Queen": 12, "Jack": 11}
    ...
    if "Ace" in ranks_maybe_with_face_cards:
        #
        high_cards_are_straight = generate_hand_with_mapped_picture_cards(map_picture_cards_ace_high)
        low_cards_are_straight = generate_hand_with_mapped_picture_cards(map_picture_cards_ace_low)
...
def is_full_house(a_hand):
    (most_frequent_card_count, len_count_object) = return_most_frequent_and_num_counter_elements(a_hand)
